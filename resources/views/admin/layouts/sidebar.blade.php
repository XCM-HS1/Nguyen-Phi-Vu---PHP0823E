...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-header small text-uppercase">
        <span class="menu-header-text">Accounts Manager</span>
      </li>
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('admin.order.index') }}" class="menu-link">
              <div>Orders Infomation</div>
            </a>
          </li>
        </ul>
      </li>
      <!-- Components -->
      <li class="menu-header small text-uppercase"><span class="menu-header-text">Contents Manager</span></li>
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-layout"></i>
          <div data-i18n="Layouts">Control</div>
        </a>

        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('admin.blog.index') }}" class="menu-link">
              <div>Blogs Manager</div>
            </a>
          </li>
          <li class="menu-item">
